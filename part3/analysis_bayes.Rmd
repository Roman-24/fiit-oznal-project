...
```{r}
cond_prob_pm10 <- cpquery(
        fitted_network,
        event = (warning_PM10 == "Warning"),
        evidence = (warning_PM2.5 == "Warning" & warning_CO == "Warning" & warning_SO2 == "Warning")
)
print(paste("Conditional Probability of Warning for PM10 given Warnings for PM2.5, CO, and SO2: ", cond_prob_pm10))
```
...
#### Riešenie
```{r}
cond_prob_so2 <- cpquery(
        fitted_network,
        event = (warning_SO2 == "Warning"),
        evidence = (warning_NH3 == "No Warning" & warning_CO == "No Warning" & warning_C2H3NO5 == "Warning" & warning_CH4 == "Warning")
)
print(paste("Conditional Probability of Warning for SO2 given No Warning for NH3 and CO and Warning for C2H3NO5 and CH4: ", cond_prob_so2))
```
