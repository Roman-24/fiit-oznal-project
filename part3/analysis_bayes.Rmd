...
# Create warning columns based on these thresholds
...
```{r}
# Calculate the sum of "Warning" entries for each pollutant and divide by the total count
...
**Question:** What is the joint probability of receiving a warning for both PM2.5 and SO2 being in the "High" category?
...
**Question:** What is the marginal probability that the NH3 level triggers a warning?
...
**Question 1:** Given that a warning has been issued for PM10, what is the probability that CO also exceeds its threshold level?

**Mathematical Representation:**

$$ P(\text{Warning}_{\text{CO}} = \text{"Warning"} \mid \text{Warning}_{\text{PM10}} = \text{"Warning"}) $$

**Question 2:** What is the probability that PM2.5 is in the "High" category given that NH3 is also in the "High" category?
