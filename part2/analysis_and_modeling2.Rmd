...
# Ensure testData$warning is a factor with specific levels
...
# Convert predictions to factor and ensure they have the same levels as testData$warning
...
# Now compute the confusion matrices
...
# You can print out these matrices or specific metrics like this:
print(cm1$overall['Accuracy'])
print(cm2$overall['Accuracy'])
print(cm3$overall['Accuracy'])

# ROC Curve and AUC
# Depending on your model, you might need to use different functions to get probabilities
...
# For a more detailed comparison, you can consider other metrics and visualization techniques.
