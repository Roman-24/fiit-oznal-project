...
legend("bottomright", legend=c("GLM", "LDA", "SVM", "LDA_TWEAK1", "SVM_TWEAK1"), col=c("red", "blue", "green", "black", "pink"), lwd=2)
...
print(paste("LDA F1 Score:", f1_lda_Tweak1))
print(paste("SVM F1 Score:", f1_svm_Tweak1))
